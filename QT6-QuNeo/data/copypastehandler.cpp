    ...
    QObject(parent)
{
...
#ifndef Q_OS_MAC
    QFile menuStyleFile = QFile(":/resources/stylesheets/menuBarWin.qss");
    QString menuStyleString;

    if (menuStyleFile.open(QFile::ReadOnly))
    {
        qDebug() << "Applying menuBar stylesheet - width: " << mWindow->width();
    ...
    menuBar->setGeometry(0,0, mWindow->width(), 25);
#endif
